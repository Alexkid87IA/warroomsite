...
const DashboardPage = () => (
  <div className="space-y-6">
    <div className="bg-gradient-to-r from-amber-900/30 via-amber-800/20 to-transparent border border-amber-500/30 rounded-xl p-5">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="text-slate-300 mt-2">Lettre offensive envoyée le 16 janvier 2026. Mise en demeure formelle avec délais : 15 jours pour documents et transfert des actifs, 30 jours pour position sur réparation du préjudice. Contre-créance ADN notifiée : 800k - 1,3M €.</div>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <StatCard label="Contre-créance ADN" value="800k - 1,3M €" type="success" />
